...
@interface TLLiveHotMainVC ()< UICollectionViewDataSource , UICollectionViewDelegate , UICollectionViewDelegateFlowLayout >

@end


@implementation TLLiveHotMainVC
...
-(void)initCollectionView
{
    ...
    // 创建一屏的视图大小
    UICollectionView *collectionView=[[ UICollectionView alloc ] initWithFrame:CGRectMake(0,0,APPW,APPH-64-49-100) collectionViewLayout:layout];
