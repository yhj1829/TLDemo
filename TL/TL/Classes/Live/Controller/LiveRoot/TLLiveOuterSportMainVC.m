...
@interface TLLiveOuterSportMainVC ()< UICollectionViewDataSource , UICollectionViewDelegate , UICollectionViewDelegateFlowLayout >

@end


@implementation TLLiveOuterSportMainVC
