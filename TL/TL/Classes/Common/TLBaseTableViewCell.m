...
- (UILabel *)nameLabel
{
    ...
    if (!_nameLabel) {
        _nameLabel=[self getLabelWithText:@"龙腾科技技术群" font:Font_Number(14) textColor:[UIColor blackColor] textAlignment:NSTextAlignmentLeft lineBreakMode:NSLineBreakByCharWrapping numberOfLines:1];
